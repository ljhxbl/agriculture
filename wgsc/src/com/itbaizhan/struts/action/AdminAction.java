...
import com.itbaizhan.struts.form.AdminForm;
...
public class AdminAction extends BaseAction {
	...
	public ActionForward addAdmin(ActionMapping mapping, ActionForm form,
		...
		try{
			...
			logger.info("��ִ��AdminAction���е�addAdmin����ʱ���?\n");
			ex.printStackTrace();
		}
	...
	public ActionForward browseAdmin(ActionMapping mapping, ActionForm form,
		...
		try{
			...
			logger.info("��ִ��AdminAction���е�browseAdmin����ʱ���?\n");
			ex.printStackTrace();
		}
	...
	public ActionForward delAdmin(ActionMapping mapping, ActionForm form,
		...
		try{
			...
			logger.info("��ִ��AdminAction���е�delAdmin����ʱ���?\n");
			ex.printStackTrace();
		}
	...
	public ActionForward loadAdmin(ActionMapping mapping, ActionForm form,
		...
		try{
			...
			logger.info("��ִ��AdminAction���е�loadAdmin����ʱ���?\n");
			ex.printStackTrace();
		}
	...
	public ActionForward modiAdmin(ActionMapping mapping, ActionForm form,
		...
		try{
			...
			logger.info("��ִ��AdminAction���е�modiAdmin����ʱ���?\n");
			ex.printStackTrace();
		}
		return mapping.findForward("modify");		
	}
